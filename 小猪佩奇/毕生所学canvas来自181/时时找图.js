    ...
    while (true) {
        ...
        ad.Refresh(function(canvas) {
            if (p) {
                ...
                log(p);
                //画圆。
                canvas.drawCircle(p.x - 22, p.y, 22, paint);
                //画上面的三条线。
                canvas.drawLine(p.x - 22, p.y, 242, 247, paint);
                canvas.drawLine(p.x - 22, p.y, 960, 247, paint);
                canvas.drawLine(p.x - 22, p.y, 1682, 247, paint);
                //画下面的三条线。
                canvas.drawLine(p.x - 22, p.y, 242, 968, paint);
                canvas.drawLine(p.x - 22, p.y, 960, 968, paint);
                canvas.drawLine(p.x - 22, p.y, 1682, 968, paint);
            };
        });
